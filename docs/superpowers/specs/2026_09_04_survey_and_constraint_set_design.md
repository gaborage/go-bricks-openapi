...
- `constraintsFor(shape, underlyingKind, constraints) constraintSet` replaces `mapConstraintToOpenAPI`; handlers become `func(*constraintSet, key, value, effKind) bool`, dispatch order unchanged.
